...
SCHEMA_PATH = Path('C:/Users/yarde/Desktop/DevPipe/kehilot/kehilot/projects/db/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    authchallenge: 'actions.AuthChallengeActions[models.AuthChallenge]'
    subject: 'actions.SubjectActions[models.Subject]'
    group: 'actions.GroupActions[models.Group]'
    groupuserrole: 'actions.GroupUserRoleActions[models.GroupUserRole]'
    note: 'actions.NoteActions[models.Note]'
    issue: 'actions.IssueActions[models.Issue]'
    ...
    def __init__(
        ...
        *,
        ...
        self.authchallenge = actions.AuthChallengeActions[models.AuthChallenge](self, models.AuthChallenge)
        self.subject = actions.SubjectActions[models.Subject](self, models.Subject)
        self.group = actions.GroupActions[models.Group](self, models.Group)
        self.groupuserrole = actions.GroupUserRoleActions[models.GroupUserRole](self, models.GroupUserRole)
        self.note = actions.NoteActions[models.Note](self, models.Note)
        self.issue = actions.IssueActions[models.Issue](self, models.Issue)
...
class Batch:
    ...
    authchallenge: 'AuthChallengeBatchActions'
    subject: 'SubjectBatchActions'
    group: 'GroupBatchActions'
    groupuserrole: 'GroupUserRoleBatchActions'
    note: 'NoteBatchActions'
    issue: 'IssueBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.authchallenge = AuthChallengeBatchActions(self)
        self.subject = SubjectBatchActions(self)
        self.group = GroupBatchActions(self)
        self.groupuserrole = GroupUserRoleBatchActions(self)
        self.note = NoteBatchActions(self)
        self.issue = IssueBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class AuthChallengeBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class GroupUserRoleBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
