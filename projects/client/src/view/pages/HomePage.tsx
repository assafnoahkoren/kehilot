...
export const HomePage: FC = () => {
	...
	return <div className='flex flex-col justify-between h-full '>
		...
		<div className='relative'>
			...
			<div className='relative flex flex-col gap-4 w-full h-72 bg-white rounded-t-[1rem] p-4 px-3'>

				{/* <SearchBar placeholder='חיפוש'/> */}
				<div className='flex flex-col gap-4 flex-1'>
					<div className='flex w-full gap-4 h-2/3'>
						<Button onClick={() => navigate('/s/polls')} className='flex flex-col flex-1 rounded-xl text-2xl'>
