...
export const Shell: FC<CompProps> = props => {
	...
	return (
		<div className={`flex h-full`} style={{backgroundColor: layoutState.backgroundColor}}>
			{layoutState.backgroundColor === 'blur' && <div className='fixed left-0 top-0 w-full blur-[150px] scale-125 z-0'>
				<svg width="100vw" height="100vh" viewBox="0 0 360 640" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path fillRule="evenodd" clipRule="evenodd" d="M-5.61574 462.172C65.6345 459.758 143.963 482.422 166.753 549.91C190.118 619.102 144.654 688.276 84.973 730.433C28.0119 770.669 -47.8981 782.577 -104.018 741.178C-159.024 700.602 -168.131 624.913 -145.408 560.485C-124.471 501.12 -68.5801 464.305 -5.61574 462.172Z" fill="#6E77E0" fillOpacity="0.45"/>
					...
					<path fillRule="evenodd" clipRule="evenodd" d="M197.801 345.387C242.468 331.782 295.863 332.842 321.721 371.674C348.233 411.487 331.196 462.956 300.586 499.744C271.37 534.855 225.365 555.256 182.843 538.578C141.166 522.232 122.574 475.893 126.028 431.281C129.211 390.175 158.329 357.41 197.801 345.387Z" fill="#F2A0A0"/>
					<path fillRule="evenodd" clipRule="evenodd" d="M112.817 -64.8838C198.338 -62.0721 255.52 12.1311 283.033 93.28C312.043 178.844 322.628 284.185 248.757 336.066C177.055 386.423 88.34 331.627 17.9419 279.457C-49.7659 229.281 -118.064 162.148 -95.6588 80.8297C-70.7372 -9.62129 19.1799 -67.9623 112.817 -64.8838Z" fill="#FFC244"/>
				</svg>
			</div>}
